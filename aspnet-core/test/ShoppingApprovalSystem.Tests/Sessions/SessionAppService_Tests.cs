...
using Shouldly;
using Xunit;
using ShoppingApprovalSystem.Sessions;

namespace ShoppingApprovalSystem.Tests.Sessions
{
    public class SessionAppService_Tests : ShoppingApprovalSystemTestBase
    {
